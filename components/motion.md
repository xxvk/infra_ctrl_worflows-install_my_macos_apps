...
- Preferred source: Mac App Store: https://apps.apple.com/app/motion/id434290957?mt=12
...
- Installed path: `/Applications/Motion.app`
- Installed version: `6.0`
- Installed footprint: `3274219520` bytes, measured with `du -sk`.
