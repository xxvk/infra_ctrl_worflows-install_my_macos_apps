...
download_estimate_bytes: 4000000000
...
- Preferred source: Mac App Store: https://apps.apple.com/app/compressor/id424390742?mt=12
...
- Planning download estimate: 4000000000 bytes (`size_gb` catalog estimate).
...
- Installed path: `/Applications/Compressor.app`
- Installed version: `5.0`
- Installed footprint: `151367680` bytes, measured with `du -sk`.
