...
app_store_id: 422689480
app_store_url: "https://apps.apple.com/app/id422689480"
region_availability: []
...
> [!summary] Purpose
> core expansion 2026-08 (user selection). iOS bundle `com.google.Gmail`,
> App Store id `422689480`. Pixel 预装
...
```text
macappstore://itunes.apple.com/app/id422689480
```
