...
app_store_url: "https://apps.apple.com/app/id686449807"
region_availability: []
...
> [!summary] Purpose
> v0 core app (purchase-history extraction, 2026-08). iOS bundle `ph.telegra.Telegraph`,
> App Store id `686449807`.
...
```text
macappstore://itunes.apple.com/app/id686449807
```
