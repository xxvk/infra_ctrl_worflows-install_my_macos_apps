...
app_store_url: "https://apps.apple.com/app/id333903271"
region_availability: []
...
> [!summary] Purpose
> v0 core app (purchase-history extraction, 2026-08). iOS bundle `com.atebits.Tweetie2`,
> App Store id `333903271`.
...
```text
macappstore://itunes.apple.com/app/id333903271
```
