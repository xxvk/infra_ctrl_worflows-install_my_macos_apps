...
app_store_url: "https://apps.apple.com/app/id401626263"
region_availability: []
...
> [!summary] Purpose
> core expansion 2026-08 (user selection). iOS bundle `com.airbnb.app`,
> App Store id `401626263`.
...
```text
macappstore://itunes.apple.com/app/id401626263
```
