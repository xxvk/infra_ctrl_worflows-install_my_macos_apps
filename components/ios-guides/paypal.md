...
app_store_id: 283646709
app_store_url: "https://apps.apple.com/app/id283646709"
region_availability: []
...
> [!summary] Purpose
> core expansion 2026-08 (user selection). iOS bundle `com.yourcompany.PPClient`,
> App Store id `283646709`.
...
```text
macappstore://itunes.apple.com/app/id283646709
```
