...
app_store_url: "https://apps.apple.com/app/id389801252"
region_availability: []
...
> [!summary] Purpose
> v0 core app (purchase-history extraction, 2026-08). iOS bundle `com.burbn.instagram`,
...
```text
macappstore://itunes.apple.com/app/id389801252
```
