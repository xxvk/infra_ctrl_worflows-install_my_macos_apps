...
- Preferred source: Mac App Store: https://apps.apple.com/us/app/capcut-photo-video-editor/id1500855883?platform=mac
...
- Planning download estimate: 2000000000 bytes (`size_gb` catalog estimate).
...
- Installed path: `/Applications/CapCut.app`
- Installed version: `8.3.0`
- Installed footprint: `2242093056` bytes, measured with `du -sk`.
