...
class ReleaseCheckTests(unittest.TestCase):
    def test_default_suite_is_hermetic_and_excludes_live_smoke(self) -> None:
        ...
        self.assertIn("browser-sources", ids)
        self.assertIn("browser-review-policy", ids)
        self.assertIn("browser-lifecycle-policy", ids)
        self.assertIn("browser-evidence-policy", ids)
        self.assertIn("browser-reconciliation-policy", ids)
        self.assertIn("browser-organization-contract", ids)
        self.assertIn("browser-gateway-policy", ids)
        self.assertIn("browser-transaction-contract", ids)
        self.assertIn("browser-acceptance", ids)
