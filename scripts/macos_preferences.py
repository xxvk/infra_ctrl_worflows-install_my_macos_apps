...
ALLOWLIST = {
    ...
    "com.apple.dock": {"autohide", "tilesize", "orientation", "mineffect", "show-recents", "showhidden", "show-process-indicators", "expose-group-apps", "launchanim", "minimize-to-application"},
